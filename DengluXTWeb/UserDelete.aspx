<%@ Page Title="" Language="C#" MasterPageFile="~/MainSite.Master" AutoEventWireup="true" CodeBehind="UserDelete.aspx.cs" Inherits="DengluXTWeb.UserDelete" %>
    ...
    <form id="form1" runat="server">
        <table>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="tbPwd" type="password" runat="server" Enabled="false"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="tbName" runat="server" Enabled="false"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="tbSex" runat="server" Enabled="false">
            ...
            <tr>
                ...
                <td><asp:TextBox ID="tbBirtday" type="date" runat="server" Enabled="false"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Home.aspx">返回用户列表</asp:HyperLink>
                </td>
                <td></td>
            </tr>
        </table>
